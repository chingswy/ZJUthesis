...
\begin{figure}[htbp]
    ...
    \subfigure[演员冯]{
        \begin{minipage}[t]{0.3\linewidth}
            \centering
            \includegraphics[width=\linewidth]{figure/2dpose/feng_ap} %
        \end{minipage}% 
    }% 
    \subfigure[演员帅]{
        \begin{minipage}[t]{0.3\linewidth}
            \centering
            \includegraphics[width=\linewidth]{figure/2dpose/shuai_ap} %
        \end{minipage}% 
    }%
    \subfigure[演员柯]{
        \begin{minipage}[t]{0.3\linewidth}
            \centering
            \includegraphics[width=\linewidth]{figure/2dpose/ke_ap} %
        \end{minipage}% 
    }%  
...
\begin{figure}[htbp]
    ...
    \subfigure[演员冯]{
        \begin{minipage}[t]{0.3\linewidth}
            \centering
            \includegraphics[width=\linewidth]{figure/2dpose/feng_op} %
        \end{minipage}% 
    }% 
    \subfigure[演员帅]{
        \begin{minipage}[t]{0.3\linewidth}
            \centering
            \includegraphics[width=\linewidth]{figure/2dpose/shuai_op} %
        \end{minipage}% 
    }%
    \subfigure[演员柯]{
        \begin{minipage}[t]{0.3\linewidth}
            \centering
            \includegraphics[width=\linewidth]{figure/2dpose/ke_op} %
        \end{minipage}% 
    }%  
